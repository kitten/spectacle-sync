...
import {
  Appear, BlockQuote, Cite, CodePane, ComponentPlayground, Fill,
...
import Interactive from './spectacle-example-files/interactive';

const images = {
  city: '/spectacle-example-files/city.jpg',
  kat: '/spectacle-example-files/kat.png',
  logo: '/spectacle-example-files/formidable-logo.svg',
  markdown: '/spectacle-example-files/markdown.png'
};
...
export default class Presentation extends React.Component {
  ...
  render() {
    return (
      <NetworkDeck transition={['zoom', 'slide']} theme={theme} transitionDuration={500}>
        ...
        >
          <CodePane
            lang="jsx"
            source={require('./spectacle-example-files/deck.example')}
            margin="20px auto"
            overflow = "overflow"
          />
        </Slide>
